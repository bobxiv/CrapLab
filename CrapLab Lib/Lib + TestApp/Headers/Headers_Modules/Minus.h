///Clase templatizada, extiende RES_Base, representa un "mini arbol" que simboliza la operacion binaria de resta entre dos elementos
...
class Minus:public RES_Base<L,R,T,U>{
public:
	...
	inline Minus( const L&, const R&);

	///Devuelve el elemento de la posicion especificada que estara en el resultado, luego de ejcutar la resta
	...
	inline Store::Minus<L,R,T,U>& operator=( const Store::Minus<L,R,T,U>& );
...
///Especializacion de los templates Minus para la resta por un escalar, del lado IZQUIERDO
...
class Minus<L,R,L,U>:public RES_Base<L,R,L,U>{
public:
	...
	inline Store::Minus<L,R,L,U>& operator=( const Store::Minus<L,R,L,U>& );
	

};

	template<class L, class R, class U>
inline typename promote<L,U>::res Store::Minus<L,R,L,U>::operator[](int i) const{
	...
	template<class L, class R, class U>
inline int Store::Minus<L,R,L,U>::Length() const{
	...
	template<class L, class R, class U>
inline Store::Minus<L,R,L,U>& Store::Minus<L,R,L,U>::operator=(const Store::Minus<L,R,L,U>& TWO ){
...
///Especializacion de los templates Minus para la resta por un escalar, del lado DERECHO
...
class Minus<L,R,T,R>:public RES_Base<L,R,T,R>{
public:
	...
	inline Store::Minus<L,R,T,R>& operator=( const Store::Minus<L,R,T,R>& );
	

};

	template<class L, class R, class T>
inline typename promote<T,R>::res Store::Minus<L,R,T,R>::operator[](int i) const{
	...
	template<class L, class R, class T>
inline int Store::Minus<L,R,T,R>::Length() const{
	...
	template<class L, class R, class T>
inline Store::Minus<L,R,T,R>& Store::Minus<L,R,T,R>::operator=(const Store::Minus<L,R,T,R>& TWO ){
...
//-----------------------------------  Definicion
	...
	template<class L, class R,class T,class U>
inline Minus<L,R,T,U>::Minus( const L& LEFT, const R& RIGHT):RES_Base<L,R,T,U>::RES_Base(LEFT,RIGHT){

}

	template<class L,class R,class T, class U>
inline typename promote<T,U>::res Minus<L,R,T,U>::operator[](int i) const{

	//Devuelve la componente resultado de la resta
	...
	template <class L,class R,class T,class U>
inline bool Minus<L,R,T,U>::Does_Components_Match(){
	...
	template <class L,class R,class T,class U>
inline int Minus<L,R,T,U>::Length() const{
	...
	template <class L,class R,class T,class U>
inline Store::Minus<L,R,T,U>& Store::Minus<L,R,T,U>::operator=( const Store::Minus<L,R,T,U>& TWO ){
