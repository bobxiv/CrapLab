...
///DE LA FUNCION CEIL
	template<>
class CEIL<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
				
			Store::Matrix<double> res(val.Get_F(), val.Get_C());

			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = ceil(val.Get_Component(i,j));
...
///DE LA FUNCION FLOOR
	template<>
class FLOOR<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = floor(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = sin(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = cos(val.Get_Component(i,j));
...
///DE LA FUNCION SQRT
	template<>
class Sqrt<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = sqrt(val.Get_Component(i,j));
...
///DE LA FUNCION SINH
	template<>
class SinH<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = sinh(val.Get_Component(i,j));
...
///DE LA FUNCION COSH
	template<>
class CosH<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = cosh(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = tan(val.Get_Component(i,j));
...
///DE LA FUNCION TANH
	template<>
class TanH<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = tanh(val.Get_Component(i,j));
...
///DE LA FUNCION ASIN
	template<>
class ASin<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = asin(val.Get_Component(i,j));
...
///DE LA FUNCION ACOS
	template<>
class ACos<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = acos(val.Get_Component(i,j));
...
///DE LA FUNCION ATAN
	template<>
class ATan<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = atan(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = abs(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = log(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = log10(val.Get_Component(i,j));
...
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val ){
			...
			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = exp(val.Get_Component(i,j));
...
class Pow<double>{
public:
	inline static double Get( double val,double pot ){
		return powf(val,pot);
	}
};
...
///DE LA FUNCION POW
	template<>
class Pow<Store::Matrix<double>>{
public:
	inline static Store::Matrix<double> Get( const Store::Matrix<double> val , double pot  ){
				
			Store::Matrix<double> res(val.Get_F(), val.Get_C());

			for(int i=1;(i <= res.Get_F());i++)
				for(int j=0;(j <= res.Get_C());j++)
					res.Get_Component(i,j) = pow(val.Get_Component(i,j),pot);
